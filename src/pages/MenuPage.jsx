...
const MenuPage = () => {
  ...
  const menuItems = {
    chai: [
      { name: "Chai Cutting", price: "$3.50", desc: "Half cup of intense, perfectly brewed chai", popular: false },
      { name: "Chai Full", price: "$5.50", desc: "Full cup of our signature spiced chai", popular: false },
      ...
      { name: "Mango Lassi", price: "$7.50", desc: "Creamy yogurt smoothie with fresh mango", popular: false },
    ...
    cold: [
      { name: "Cold Coffee", price: "$7.50", desc: "Iced coffee blend with cream", popular: false },
      { name: "Iced Tea", price: "$4.50", desc: "Chilled tea with refreshing flavors", popular: false },
      { name: "Badam Milk", price: "$7.50", desc: "Almond-infused milk drink", popular: false },
      { name: "Milk Shake", price: "$7.50", desc: "Creamy classic milkshake", popular: false },
      { name: "Oreo Shake", price: "$10.50", desc: "Loaded with Oreo cookie goodness", popular: false },
      { name: "Kitkat Shake", price: "$10.50", desc: "Crispy wafer chocolate shake", popular: false },
      { name: "Ferrero Rocher Shake", price: "$10.50", desc: "Premium hazelnut chocolate shake", popular: false },
      { name: "Lemon Soda", price: "$5.50", desc: "Fresh lemon with fizzy soda", popular: false },
    ],
    snacks: [
      { name: "Vadapav", price: "$6.00", desc: "Mumbai's famous spiced potato burger", popular: false },
      { name: "Samosa Pav", price: "$6.00", desc: "Crispy samosa served in a bun", popular: false },
      { name: "Dabeli", price: "$6.00", desc: "Sweet & spicy potato in a bun", popular: false },
      { name: "Bun Maska", price: "$4.50", desc: "Soft bun with butter - chai's best friend", popular: false },
      { name: "Cheese Vadapav", price: "$8.50", desc: "Vadapav loaded with melted cheese", popular: false },
    ...
    mains: [
      { name: "Plain Maggi", price: "$7.50", desc: "Classic instant noodles done right", popular: false },
      { name: "Cheese Maggi", price: "$10.50", desc: "Loaded with melted cheese", popular: false },
      { name: "Tandoori Maggi", price: "$10.50", desc: "Spiced with tandoori flavors", popular: false },
      { name: "Maggi Super Special", price: "$12.50", desc: "Our ultimate loaded Maggi", popular: false },
      { name: "Grilled Sandwich", price: "$4.50", desc: "Classic grilled veg sandwich", popular: false },
      { name: "Paneer Makhani Sandwich", price: "$8.50", desc: "Rich paneer in makhani sauce", popular: false },
      { name: "Tandoori Paneer Sandwich", price: "$9.50", desc: "Spiced tandoori paneer filling", popular: false },
      { name: "Chili Paneer Sandwich", price: "$9.50", desc: "Indo-Chinese style paneer", popular: false },
    ],
    sides: [
      { name: "Plain Fries", price: "$7.00", desc: "Crispy golden French fries", popular: false },
      { name: "Peri Peri Fries", price: "$9.00", desc: "Spiced with peri peri seasoning", popular: false },
      { name: "Cheese Fries", price: "$10.50", desc: "Loaded with melted cheese", popular: false },
      ...
      { name: "Butter Paratha", price: "$8.00", desc: "Paratha with butter", popular: false },
      { name: "Paneer Paratha", price: "$10.00", desc: "Stuffed with spiced paneer", popular: false },
    ],
  }
